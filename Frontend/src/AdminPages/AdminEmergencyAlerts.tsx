...
import { API_BASE_URL, NotificationHistoryItem, NotificationStats } from '../interfaces'; // Adjust path
...
const AdminEmergencyAlerts = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const resData = await axios.get(`${API_BASE_URL}/api/user/priority`, config);
                    ...
                    <section className="lg:col-span-5 bg-white border border-gray-100 shadow-sm p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                disabled={isSending}
                                className="w-full bg-red-600 disabled:bg-red-400 text-white py-4 font-bold flex items-center justify-center gap-2 hover:bg-red-700 transition-all shadow-lg shadow-red-100 active:scale-[0.98]"
                            >
