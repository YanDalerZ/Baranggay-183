...
import {
  User as UserIcon, FileText, LogOut, Sun, Menu, X,
  Home, UserCog, AlertTriangle,
  Settings, Boxes, MoreHorizontal
} from 'lucide-react';
...
const SuperAdminNavbar: React.FC<NavbarProps> = ({ children }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', shortName: 'Dash', icon: Home, path: '/SuperAdminDashboard' },
    { name: 'User Access & RBAC', shortName: 'Access', icon: UserCog, path: '/SuperAdminRBAC' },
    { name: 'Master Audit Trail', shortName: 'Audit', icon: FileText, path: '/SuperAdminAuditTrail' },
    { name: 'Global Configuration', shortName: 'Config', icon: Settings, path: '/SuperAdminConfiguration' },
    { name: 'Database Maintenance', shortName: 'Database', icon: Boxes, path: '/SuperAdminDatabase' },
    { name: 'Compliance Monitor', shortName: 'Monitor', icon: AlertTriangle, path: '/SuperAdminCompliance' },
  ];
