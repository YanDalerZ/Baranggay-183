                    ...
                    <div className="py-4">
                        ...
                        <div className="benefit-item">
                            <div className="space-y-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="flex items-center gap-1 bg-black text-white px-2 py-0.5 rounded text-[10px] uppercase font-bold">
                                ...
                                <div className="flex gap-2">
                                    <span className="text-[10px] bg-gray-100 px-2 py-0.5 rounded font-bold text-gray-500">Senior Citizen</span>
                                </div>
                            </div>
                        ...
                        <div className="benefit-item">
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <span className="text-[10px] bg-gray-100 px-2 py-0.5 rounded font-bold text-gray-500">PWD</span>
                                </div>
                            </div>
