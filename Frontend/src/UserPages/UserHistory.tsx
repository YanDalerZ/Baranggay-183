...
const ClaimItem = ({ claim }: { claim: ClaimRecord }) => (
    <div className="bg-white border-2 border-gray-100 rounded-3xl p-6 mb-4 hover:border-[#00308F] transition-all group">
    ...
    return (
        <div className=" min-h-screen bg-[#FDFDFD] pb-20">
            ...
            <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
                ...
                {/* Legend Section */}
                <section className="bg-white border-2 border-gray-100 rounded-3xl p-8">
                    ...
                    <div className="grid grid-cols-1 gap-8">
                        <div className="flex items-start gap-6">
                            <div className="bg-orange-100 p-3 rounded-2xl"><Clock className="text-[#FF9800]" size={24} /></div>
                            <div>
                        ...
                        <div className="flex items-start gap-6">
                            <div className="bg-blue-100 p-3 rounded-2xl"><Package className="text-[#00308F]" size={24} /></div>
                            <div>
                        ...
                        <div className="flex items-start gap-6">
                            <div className="bg-green-100 p-3 rounded-2xl"><CheckCircle2 className="text-green-600" size={24} /></div>
                            <div>
